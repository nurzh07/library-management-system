...
- Name: auth.spec.js >> Authentication E2E Tests >> should show error for invalid login
- Location: tests\auth.spec.js:47:3
...
Locator: [role="alert"], .MuiAlert-root, text=/қате|жарамсыз|дұрыс|invalid/i >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "[role="alert"], .MuiAlert-root, text=/қате|жарамсыз|дұрыс|invalid/i". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [role="alert"], .MuiAlert-root, text=/қате|жарамсыз|дұрыс|invalid/i >> nth=0
...
- generic [ref=e3]:
  - banner [ref=e4]:
    - generic [ref=e6]:
      - link "LMS · Кітапхана" [ref=e7] [cursor=pointer]:
        - /url: /
      ...
      - generic [ref=e19]:
        ...
        - generic [ref=e23]:
          - generic:
            ...
            - generic: "*"
          - generic [ref=e24]:
            - textbox "Құпиясөз" [ref=e25]
            - group:
              - generic: Құпиясөз *
        - button "Кіру" [ref=e26] [cursor=pointer]: Кіру
```
