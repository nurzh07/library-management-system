...
- Name: books.spec.js >> Books E2E Tests >> should display books list
- Location: tests\books.spec.js:4:3
...
Call log:
  - waiting for locator('[data-testid="books-grid"]') to be visible
    23 × locator resolved to hidden <div data-testid="books-grid" class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3 css-zow5z4-MuiGrid-root"></div>
