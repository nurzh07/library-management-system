...
- Name: books.spec.js >> Books E2E Tests >> should search books
- Location: tests\books.spec.js:17:3
...
Call log:
  - waiting for locator('[data-testid="books-search"]')
    - locator resolved to <div data-testid="books-search" class="MuiFormControl-root MuiFormControl-fullWidth MuiTextField-root css-wb57ya-MuiFormControl-root-MuiTextField-root">…</div>
    - fill("test")
...
- generic [ref=e3]:
  ...
  - main [ref=e15]:
    - generic [ref=e16]:
      ...
      - generic [ref=e24]:
        - generic [ref=e25]:
          - heading "Тест кітап" [level=2] [ref=e26]
          - paragraph [ref=e27]: "ISBN: 978-1234567890"
          - paragraph [ref=e28]: "Қолда бар: 5 / 5"
        - button "Толығырақ" [ref=e30] [cursor=pointer]: Толығырақ
```
